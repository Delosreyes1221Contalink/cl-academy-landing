...
@Component({
  selector: 'app-resources-submenu',
  templateUrl: './resources-submenu.component.html',
  styleUrls: ['./resources-submenu.component.css']
})
export class ResourcesSubmenuComponent implements OnInit {
